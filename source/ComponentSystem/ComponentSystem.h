...
public:
	...
	UNIGINE_INLINE Unigine::String getValueAsString() override { return Unigine::String::format("%f %f", value.x, value.y); }
...
public:
	...
	UNIGINE_INLINE Unigine::String getValueAsString() override { return Unigine::String::format("%lf %lf", value.x, value.y); }
...
public:
	...
	UNIGINE_INLINE Unigine::String getValueAsString() override { return Unigine::String::format("%lf %lf %lf", value.x, value.y, value.z); }
...
public:
	...
	UNIGINE_INLINE Unigine::String getValueAsString() override { return Unigine::String::format("%lf %lf %lf %lf", value.x, value.y, value.z, value.w); }
...
public:
	...
	UNIGINE_INLINE Unigine::String getValueAsString() override { return Unigine::String::format("%d %d", value.x, value.y); }
...
public:
	...
	UNIGINE_INLINE Unigine::String getValueAsString() override { return Unigine::String::format("%d %d %d", value.x, value.y, value.z); }
...
public:
	...
	UNIGINE_INLINE Unigine::String getValueAsString() override { return Unigine::String::format("%d %d %d %d", value.x, value.y, value.z, value.w); }
